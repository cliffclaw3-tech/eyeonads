...
export function ReportControls(){
 ...
 return <section className="space-y-3 rounded-xl border border-white/25 p-5 print:hidden">
  ...
  {job&&<p role="status">Latest batch: {job.status} · {job.completed} of {job.total} agent searches completed. {job.error} Batch counts track queued searches; individual searches can update saved findings separately.</p>}
