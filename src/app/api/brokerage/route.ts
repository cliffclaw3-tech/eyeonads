...
export async function GET() {
 ...
 return NextResponse.json({brokerage:data?{id:data.id,name:data.name,expected_agents:data.expected_agents,scope:data.scope,website:data.website,location:data.location,discovery_agent_ids:data.discovery_agent_ids,discovery_location:data.discovery_location}:null,agents:data?.agents??[]},{headers:{'Cache-Control':'no-store'}});
}
export async function POST(request:NextRequest) {
 ...
 return NextResponse.json({brokerage:{id:data.id,name:data.name,expected_agents:data.expected_agents,scope:data.scope,website:data.website,location:data.location,discovery_agent_ids:data.discovery_agent_ids,discovery_location:data.discovery_location},agents:data.agents},{headers:{'Cache-Control':'no-store'}});
}
